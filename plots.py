...
losses_file3 = "./losses4/toy_toy_E1_task_0"
with open(losses_file3, "rb") as f3:
    losses3, accs3 = pickle.load(f3)
    

losses_file4 = "./losses4/toy_toy_E4_task_1"
with open(losses_file4, "rb") as f4:
    losses4, accs4 = pickle.load(f4)
    
    
losses_file5 = "./losses4/toy_toy_E2_task_0"
with open(losses_file5, "rb") as f5:
    losses5, accs5 = pickle.load(f5)
    
    
losses_file6 = "./losses4/toy_toy_E6_task_1"
with open(losses_file6, "rb") as f6:
    losses6, accs6 = pickle.load(f6)
    


plt.plot(losses3, color="blue", label="losses E1")
plt.plot(losses5, color="orange", label="losses E2")

#plt.plot(losses4, color="navy", label="losses E4")
#plt.plot(losses6, color="darkorange", label="losses E6")



plt.legend()
plt.savefig("./plots/E1E2_loss.pdf")

print("E3 losses", sum(losses3)/len(losses3))
print("E4 losses", sum(losses4)/len(losses4))
print("E5 losses", sum(losses5)/len(losses5))
print("E6 losses", sum(losses6)/len(losses6))
