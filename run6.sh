...
#python3 Toy_finetune.py --experiment_name "E3" --dataset "toy" --experiment_idx 2 --task_idx_model 0 --task_idx_data 1 --model_name "toy" --last_model_path "./models6/toy_toy_E1_task_0.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E4" --dataset "toy" --experiment_idx 3 --task_idx_model 0 --task_idx_data 1 --model_name "toy" --last_model_path "./models6/toy_toy_E1_task_0.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E5" --dataset "toy" --experiment_idx 4 --task_idx_model 0 --task_idx_data 1 --model_name "toy" --last_model_path "./models6/toy_toy_E2_task_0.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E6" --dataset "toy" --experiment_idx 5 --task_idx_model 0 --task_idx_data 1 --model_name "toy" --last_model_path "./models6/toy_toy_E2_task_0.pth" --model_root "./models6/" --losses_root "./losses6/"


#echo "linear probe of the task 1 model with the task 0 data"
#python3 Toy_finetune.py --experiment_name "E3" --dataset "toy" --experiment_idx 2 --task_idx_model 1 --task_idx_data 0 --model_name "toy" --last_model_path "./models6/toy_toy_E3_task_1.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E4" --dataset "toy" --experiment_idx 3 --task_idx_model 1 --task_idx_data 0 --model_name "toy" --last_model_path "./models6/toy_toy_E4_task_1.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E5" --dataset "toy" --experiment_idx 4 --task_idx_model 1 --task_idx_data 0 --model_name "toy" --last_model_path "./models6/toy_toy_E5_task_1.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E6" --dataset "toy" --experiment_idx 5 --task_idx_model 1 --task_idx_data 0 --model_name "toy" --last_model_path "./models6/toy_toy_E6_task_1.pth" --model_root "./models6/" --losses_root "./losses6/"
...
#python3 Toy_finetune.py --experiment_name "E3" --dataset "toy" --experiment_idx 2 --task_idx_model 0 --task_idx_data 2 --model_name "toy" --last_model_path "./models6/toy_toy_E1_task_0.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E4" --dataset "toy" --experiment_idx 3 --task_idx_model 0 --task_idx_data 2 --model_name "toy" --last_model_path "./models6/toy_toy_E1_task_0.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E5" --dataset "toy" --experiment_idx 4 --task_idx_model 0 --task_idx_data 2 --model_name "toy" --last_model_path "./models6/toy_toy_E2_task_0.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E6" --dataset "toy" --experiment_idx 5 --task_idx_model 0 --task_idx_data 2 --model_name "toy" --last_model_path "./models6/toy_toy_E2_task_0.pth" --model_root "./models6/" --losses_root "./losses6/"


#echo "linear probe of the task 1 model with the task 2 data"
#python3 Toy_finetune.py --experiment_name "E3" --dataset "toy" --experiment_idx 2 --task_idx_model 1 --task_idx_data 2 --model_name "toy" --last_model_path "./models6/toy_toy_E3_task_1.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E4" --dataset "toy" --experiment_idx 3 --task_idx_model 1 --task_idx_data 2 --model_name "toy" --last_model_path "./models6/toy_toy_E4_task_1.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E5" --dataset "toy" --experiment_idx 4 --task_idx_model 1 --task_idx_data 2 --model_name "toy" --last_model_path "./models6/toy_toy_E5_task_1.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E6" --dataset "toy" --experiment_idx 5 --task_idx_model 1 --task_idx_data 2 --model_name "toy" --last_model_path "./models6/toy_toy_E6_task_1.pth" --model_root "./models6/" --losses_root "./losses6/"


#echo "linear probe of the task 2 model with the task 0 data"
#python3 Toy_finetune.py --experiment_name "E3" --dataset "toy" --experiment_idx 2 --task_idx_model 2 --task_idx_data 0 --model_name "toy" --last_model_path "./models6/toy_toy_E3_task_2.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E4" --dataset "toy" --experiment_idx 3 --task_idx_model 2 --task_idx_data 0 --model_name "toy" --last_model_path "./models6/toy_toy_E4_task_2.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E5" --dataset "toy" --experiment_idx 4 --task_idx_model 2 --task_idx_data 0 --model_name "toy" --last_model_path "./models6/toy_toy_E5_task_2.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E6" --dataset "toy" --experiment_idx 5 --task_idx_model 2 --task_idx_data 0 --model_name "toy" --last_model_path "./models6/toy_toy_E6_task_2.pth" --model_root "./models6/" --losses_root "./losses6/"


#echo "linear probe of the task 2 model with the task 1 data"
#python3 Toy_finetune.py --experiment_name "E3" --dataset "toy" --experiment_idx 2 --task_idx_model 2 --task_idx_data 1 --model_name "toy" --last_model_path "./models6/toy_toy_E3_task_2.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E4" --dataset "toy" --experiment_idx 3 --task_idx_model 2 --task_idx_data 1 --model_name "toy" --last_model_path "./models6/toy_toy_E4_task_2.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E5" --dataset "toy" --experiment_idx 4 --task_idx_model 2 --task_idx_data 1 --model_name "toy" --last_model_path "./models6/toy_toy_E5_task_2.pth" --model_root "./models6/" --losses_root "./losses6/"
#python3 Toy_finetune.py --experiment_name "E6" --dataset "toy" --experiment_idx 5 --task_idx_model 2 --task_idx_data 1 --model_name "toy" --last_model_path "./models6/toy_toy_E6_task_2.pth" --model_root "./models6/" --losses_root "./losses6/"
