...
python3 Toy_metrics.py --feature_path1 "./features/toy_toy_E7_task_1_task_1_data_0_train" --feature_path2 "./features/toy_toy_E7_task_2_task_2_data_0_train" --num_classes 2 --feature_name "linear3"
python3 Toy_metrics.py --feature_path1 "./features/toy_toy_E8_task_1_task_1_data_0_train" --feature_path2 "./features/toy_toy_E8_task_2_task_2_data_0_train" --num_classes 2 --feature_name "linear3"