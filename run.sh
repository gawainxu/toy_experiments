...
python3 Toy_features.py --inliers_id 2 --model_name "toy" --model_path "./models/toy_toy_E4.pth"
python3 Toy_features.py --inliers_id 2 --model_name "toy" --model_path "./models/toy_toy_E5.pth"
python3 Toy_features.py --inliers_id 2 --model_name "toy" --model_path "./models/toy_toy_E6.pth"
python3 Toy_features.py --inliers_id 2 --model_name "toy" --model_path "./models/toy_toy_E6.pth"
python3 Toy_features.py --inliers_id 2 --model_name "toy" --model_path "./models/toy_toy_E7.pth"
