...
python3 Toy_finetune.py --experiment_name "E15" --dataset "toy" --classes_idx 4 --old_classes_idx 0 --model_name "cnn" --last_model_path "./models/cnn_toy_E1.pth" --losses_path "cnn_toy_E15"
...
python3 Toy_finetune.py --experiment_name "E28" --dataset "toy" --classes_idx 7 --old_classes_idx 1 --model_name "cnn" --last_model_path "./models/cnn_toy_E2.pth" --losses_path "cnn_toy_E28"
