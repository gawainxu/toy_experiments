...
python3 Toy_finetune.py --experiment_name "E62" --dataset "toy" --classes_idx 1 --old_classes_idx 5 --model_name "toy" --last_model_path "./models/toy_toy_E6.pth" --losses_path "cnn_toy_E62"
python3 Toy_finetune.py --experiment_name "E72" --dataset "toy" --classes_idx 1 --old_classes_idx 6 --model_name "toy" --last_model_path "./models/toy_toy_E7.pth" --losses_path "cnn_toy_E72"
python3 Toy_finetune.py --experiment_name "E82" --dataset "toy" --classes_idx 1 --old_classes_idx 7 --model_name "toy" --last_model_path "./models/toy_toy_E8.pth" --losses_path "cnn_toy_E82"